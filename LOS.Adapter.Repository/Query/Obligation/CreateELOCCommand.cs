...
{
    public class CreateELOCCommand : BaseCommand
    {
        public CreateELOCCommand(string user, string password, string bankId, string obligorNumber, string batchid, string obligationNumber, string segment, string restriction, string dataLength, string itemNumber, string luw, string restartRequestCode)
        ...
        public string x1301_LATE_CHARGE_FORMULA_TYPEo { get; set; }
        ...
        public string x1301_NOT_USED_BY_LEAD { get; set; }
        ...
        public string x1305_NOT_USED_BY_LEADA { get; set; }
        public string x1305_USER_CODE_2 { get; set; }
        public string x1305_NOT_USED_BY_LEADB { get; set; }
        ...
        public string x1339_NOT_USED_BY_LEAD2 { get; set; }
        ...
        public string x1347_NOT_USED_BY_LEAD { get; set; }
        ...
        public string x3904_EFF_DATE { get; set; }
        public string x3904_TRAN_AMT { get; set; }
        public string x3904_OVERRIDE_PASSWORD { get; set; }
