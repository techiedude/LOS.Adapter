...
namespace LOS.Adapter.Data.Services.Query.Base
{
    ...
    public abstract class BaseCommand : Command
    {
        ...
        public BaseCommand(string user, string password)
        {
            User = user;
            Password = password;
        ...
        public BaseCommand(string user, string password, string luw, string bankId, string obligorNumber, string batchId, string obligationNumber, string segment, string headerRestrictions, string dataLength, string itemNumber, string restartCode)
            : this(user, password)
        {
            BankId = bankId;
            ...
            Segment = segment;
            HeaderRestrictions = Constants.LUW_HEADER_REST_CALL_APPL;//headerRestrictions;
